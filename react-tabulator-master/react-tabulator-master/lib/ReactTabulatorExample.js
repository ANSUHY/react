...
exports["default"] = (function () {
    ...
    var renderAjaxScrollExample = function () {
        ...
        return (React.createElement(ReactTabulator_1["default"], {
            onRef: function (r) { return (ref = r); }, columns: columns, options: options, events: {
    ...
    return (React.createElement("div", null,
        React.createElement(ReactTabulator_1["default"], {
            onRef: function (ref) { return (ref = ref); }, columns: columns, data: data, events: {
                rowClick: rowClick
